    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-primary/5 to-accent/5 p-4">
      <Card className="w-full max-w-md">
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-11 -translate-y-1/2 text-gray-600 hover:text-black cursor-pointer"
              >
          ...
          {/* Demo Credentials */}
          <div className="mt-6 p-3 bg-muted/50 rounded-full">
